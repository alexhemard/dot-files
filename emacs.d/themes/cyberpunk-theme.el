...
(let ((class '((class color) (min-colors 89)))
      ...
      (cyberpunk-red-1 "#ff0066")
      (cyberpunk-red-2 "#ff0099")
      (cyberpunk-red-3 "#ff00aa")
      (cyberpunk-red-4 "#ff00cc")
      (cyberpunk-red-5 "#ff00ff")
      (cyberpunk-pink "#ff0066")
      (cyberpunk-pink-1 "#ff1493")
      (cyberpunk-pink-2 "#cd1076")
      (cyberpunk-orange-2 "#FF6400")
      (cyberpunk-orange-1 "#ffaa00") ;; DarkOrange
      (cyberpunk-orange "#ffdd00")
      (cyberpunk-yellow "#ddff00")
      (cyberpunk-yellow-1 "#ddff11")
      (cyberpunk-yellow-2 "#ddff55")
      (cyberpunk-yellow-3 "#ddff99")
      (cyberpunk-yellow-4 "#aaff44")
      (cyberpunk-yellow-5 "#aaffbb")
      (cyberpunk-green-2 "#55ff55")
      (cyberpunk-green-1 "#33ff33")
      ...
      (cyberpunk-blue "#1199ff")    ;; blue
      (cyberpunk-blue-1 "#1133ff")  ;; medium slate blue
      ...
      (cyberpunk-blue-7 "#00aaff")
      (cyberpunk-blue-8 "#4F94CD")
      (cyberpunk-magenta "#aa1144")
 ...
 (custom-theme-set-faces
   ...
   `(link ((,class (:foreground ,cyberpunk-blue :underline t :weight bold))))
   `(link-visited ((,class (:foreground ,cyberpunk-blue-2 :underline t :weight normal))))
   ...
   `(mode-line ((t (:background "gray10" :foreground ,cyberpunk-blue))))
   `(mode-line-inactive ((t (:background "gray10" :foreground "gray30"))))
   `(region ((,class (:background ,cyberpunk-blue-1))))
   ...
   ;;; font lock
   `(font-lock-builtin-face ((,class (:foreground ,cyberpunk-green-2))))
   ...
   `(rainbow-delimiters-depth-2-face ((,class (:foreground ,cyberpunk-red-2))))
   `(rainbow-delimiters-depth-3-face ((,class (:foreground ,cyberpunk-red-3))))
   `(rainbow-delimiters-depth-4-face ((,class (:foreground ,cyberpunk-red-4))))
   `(rainbow-delimiters-depth-5-face ((,class (:foreground ,cyberpunk-red-5))))
   `(rainbow-delimiters-depth-6-face ((,class (:foreground ,cyberpunk-blue-2))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground ,cyberpunk-orange-2))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground ,cyberpunk-green-2))))
   `(rainbow-delimiters-depth-9-face ((,class (:foreground ,cyberpunk-blue-2))))
   `(rainbow-delimiters-depth-10-face ((,class (:foreground ,cyberpunk-pink-2))))
   `(rainbow-delimiters-depth-11-face ((,class (:foreground ,cyberpunk-red-3))))
   `(rainbow-delimiters-depth-12-face ((,class (:foreground ,cyberpunk-green-2))))
